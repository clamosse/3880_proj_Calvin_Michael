...
ridge_model <- glmnet(as.matrix(train_data), train_data$SNWD_change, alpha = 0)  # alpha = 0 for ridge
...
Lasso Regression
```{r}
lasso_model <- glmnet(as.matrix(train_data), train_data$SNWD_change, alpha = 1)  # alpha = 1 for Lasso
