...
mse_values <- c(lm_model_mse, logReg_mse, tree_model_mse, pruned_mse, bagged_mse, rf_mse, ridge_mse, lasso_mse)

model_names <- c("Linear Regression", "Logistic Regression", "Decision Tree", "Pruned Decision Tree", "Random Forest", "Random Forest (mtry=7)", "Ridge Regression", "Lasso Regression")
...
text(x = barplot(mse_values, names.arg = model_names, main = "Mean Squared Error (MSE) of Different Models", ylab = "MSE", col = "steelblue", las = 2), y = mse_values, labels = round(mse_values, 2), pos = 3, cex = 0.8)
```